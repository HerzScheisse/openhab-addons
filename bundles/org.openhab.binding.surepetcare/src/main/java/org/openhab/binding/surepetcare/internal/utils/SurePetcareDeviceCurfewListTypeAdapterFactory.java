...
public final class SurePetcareDeviceCurfewListTypeAdapterFactory<E> implements TypeAdapterFactory {
    ...
    private static final class SurePetcareDeviceCurfewListTypeAdapter
        ...
        @Override
        public void write(final @Nullable JsonWriter out, final List<SurePetcareDeviceCurfew> list) throws IOException {
            if (out != null) {
                out.beginArray();
        ...
        @Override
        public List<SurePetcareDeviceCurfew> read(final @Nullable JsonReader in) throws IOException {
